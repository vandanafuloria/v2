...
const Footer = () => {
  ...
  const handleSignUp = (e) => {
    e.preventDefault();
    console.log('Sign up:', { firstName, email });
        ...
        <div className="footer-content">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li><a href="#" className="footer-link">Bath</a></li>
              <li><a href="#" className="footer-link">Body</a></li>
              <li><a href="#" className="footer-link">Handcream</a></li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#" className="footer-link">Peace of Mind</a></li>
              <li><a href="#" className="footer-link">Press</a></li>
              <li><a href="#" className="footer-link">Affiliate Program</a></li>
              <li><a href="#" className="footer-link">Frequently Asked Questions</a></li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#" className="footer-link">Returns and Refund Policy</a></li>
          ...
          <div className="footer-column newsletter-column">
            ...
            <form className="newsletter-form" onSubmit={handleSignUp}>
